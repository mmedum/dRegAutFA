 ...
 *    src="http://cs.au.dk/~amoeller/RegAut/Lambda.gif" alt="Lambda">)
 * <li><tt>a</tt> (where <tt>a</tt><img src="http://cs.au.dk/~amoeller/RegAut/in.gif" 
 *    alt="in"><img src="http://cs.au.dk/~amoeller/RegAut/Sigma.gif" alt="sigma">):
...
public class RegExp {
    ...
    /** 
     * Converts this regular expression to an {@link NFA}. [Martin, Th. 3.25] 
     */
    public NFA toNFA() {
        return ast.toNFA(alphabet);
    }
    ...
    static class Parser {
        ...
        /** 
         * Checks that the next char is the same as <tt>c</tt>, and then advances the position. 
         */
    ...
    abstract static class Node {
        ...
        /**
         * Constructs a new {@link NFA} automaton whose language is the same
         * as the language of this regular expression. [Martin, Th. 3.25]
         */
        abstract NFA toNFA(Alphabet a);
    ...
    static class EmptyLanguageNode extends Node {
        ...
        @Override 
        NFA toNFA(Alphabet a) {
            return NFA.makeEmptyLanguage(a).checkWellDefined();
        }
    ...
    static class EmptyStringNode extends Node {
        ...
        /** 
         * Constructs a new {@link NFA} automaton whose language is 
         * {<img src="http://cs.au.dk/~amoeller/RegAut/Lambda.gif" alt="Lambda">}.
         * In the book, <img src="http://cs.au.dk/~amoeller/RegAut/Lambda.gif" alt="Lambda"> 
         * is defined as "syntactic sugar" 
         * (<img src="http://cs.au.dk/~amoeller/RegAut/Lambda.gif" alt="Lambda"> = &Oslash;*),
         * not as a primitive construct. [Martin, p. 93] 
         */
        @Override 
        NFA toNFA(Alphabet a) {
            return NFA.makeEmptyString(a).checkWellDefined();
        }
    ...
    /**
     * Parse tree node representing <tt>a</tt><img src="http://cs.au.dk/~amoeller/RegAut/in.gif" 
     *   alt="in"><img src="http://cs.au.dk/~amoeller/RegAut/Sigma.gif" alt="sigma">. 
     */
    static class SymbolNode extends Node {
        ...
        @Override 
        NFA toNFA(Alphabet a) {
            return NFA.makeSingleton(a, c).checkWellDefined();
        }
    ...
    static class UnionNode extends Node {
        ...
        @Override 
        NFA toNFA(Alphabet a) {
            return n1.toNFA(a).union(n2.toNFA(a)).checkWellDefined();
        }
    ...
    static class ConcatNode extends Node {
        ...
        @Override 
        NFA toNFA(Alphabet a) {
            return n1.toNFA(a).concat(n2.toNFA(a)).checkWellDefined();
        }
    ...
    static class StarNode extends Node {
        ...
        @Override 
        NFA toNFA(Alphabet a) {
            return n.toNFA(a).kleene().checkWellDefined();
        }
